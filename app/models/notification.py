...
class Notification(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("tipo IN ('acceso_no_autorizado', 'pase_temporal', 'incidencia_tecnica', 'empleado_registrado', 'empleado_estado_cambiado', 'marcaje_corregido', 'lector_estado_cambiado', 'organizacion_cambiada', 'usuario_cambiado')", name='CK_notificaciones_tipo'),
    )
