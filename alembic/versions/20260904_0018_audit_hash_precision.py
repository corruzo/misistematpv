"""Align audit hash timestamps with DATETIME2 precision.
...
down_revision: Union[str, None] = '20260904_0017'
...
def upgrade() -> None:
    ...
    BEGIN
        SELECT @hash = CONVERT(CHAR(64), HASHBYTES('SHA2_256', CONCAT(
            ...
            CONVERT(NVARCHAR(40), SWITCHOFFSET(CONVERT(DATETIMEOFFSET, fecha), '+00:00'), 127), '|', ISNULL(@previous, '')
