"""Expand CK_notificaciones_tipo with organizacion_cambiada and usuario_cambiado.
...
down_revision: Union[str, None] = '20260827_0013'
...
def upgrade() -> None:
    ...
    BEGIN
        ...
        ALTER TABLE dbo.notificaciones ADD CONSTRAINT CK_notificaciones_tipo CHECK (tipo IN ('acceso_no_autorizado', 'pase_temporal', 'incidencia_tecnica', 'empleado_registrado', 'empleado_estado_cambiado', 'marcaje_corregido', 'lector_estado_cambiado', 'organizacion_cambiada', 'usuario_cambiado'));
    END
    """)
